...
<body>
      ...
      <div class="row design">
         <div class="six columns feature-media left">
			<div class="ticket_window">
				<iframe src="https://www.picatic.com/events/widget/105221?width=std&ticket_description=true" frameborder="0" style="display:block;height:313px;max-width:none;width:100%;"></iframe>
			</div>
			<div class="buttons">
				<a class="button" value="Köp biljett" href="https://www.picatic.com/geekevolution?utm_source=promotion&utm_medium=button&utm_campaign=105221" target="_blank">Till anmälningssidan</a>
			 </div>
         </div>
  ...
  <section id="sponsors">
   ...
   <!--section id='ggmif'>
      ...
      <div class="row feature design">
         ...
         <div class="six columns right">
            ...
            <p>Geek Girl Meetup är ett nätverk för alla som identifierar sig som nördiga tjejer.
            </p>
         </div>
      ...
      <div class="row feature responsive">
         ...
         <div class="six columns left">
            ...
            <p>Geek Girl Meetup Ideella Förening arbetar aktivt med att skapa och lyfta kvinnliga förebilder inom IT-branschen. Vårt mål är att skapa ett brett nätverk inom bland annat IT, spel och startup-världen. Och att ha kul såklart! Vi gör detta genom att låta våra medlemmar dela med sig av kunskap till andra. På så sätt vill vi skapa rätt förutsättningar för kunskapsutbyte och förhoppningsvis fler kontakter eller vänner inom sitt yrke eller hobby.
            <br/>
            Bli medlem i Geek Girl Meetup Ideella Förening och få chansen att påverka, driva och utveckla nätverket Geek Girl Meetup. Medlemsavgiften för 2015 är 150 kr och sätts in på BG 172-2321 tillsammans med ditt namn och email. Vi kommer inom kort att berätta mer om styrelsearbetet och om vad som är på gång inom Geek Girl Meetup Ideella Förening (GGMIF).
            <br/>
            Har du frågor eller undrar mer så kan du kontakta GGMIF:s styrelse på info@ggmif.se
            </p>
         </div>
   ...
   </section--> <!-- --GGMIF tidigare Features end -->
   ...
   <!--section id="call-to-action">
      ...
      <div class="row">
         ...
         <div class="seven columns">
            ...
            <h2><a href="#">Sponsring</a></h2>
            <p>Interesserad av att sponsra rikseventet? Läs mer på <a href="#"><span>Länk</span></a>.
            </p>
