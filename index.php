    ...
    <div class="row section-head">
      ...
      <!--div class="row">
        ...
        <p>Detaljerat program kommer längre fram i vår. Tills dess, spana in <a href="#talare" class="smoothscroll">våra bokningar!</a></p>
			...
			<div class="programMobile">
				<div class="programDay">
				
					<div class="programVenue">
					
						<div class="programItem common">
							<time>09:00 - 09:30</time>
							<h3>Registrering & frukost</h3>
						</div>
						
						<div class="programItem venue1">
						...
						<div class="programItem venue1">
							...
							<h3>Future tech</h3>
							<h4 class="programSpeaker">Claudia Olsson</h4>
						</div>
						<div class="programItem venue1">
							<time>10:45 - 11:15</time>
							<a href="#" onclick="openOverlay('beckfriisoverlay', event)">	
								<h3>Från förändring till förnyelse</h5>
								<h4 class="programSpeaker" >Cecilia Beck-Friis</h6>
							</a>
						</div>
						<div class="programItem venue2">
							<time>10:45 - 11:00</time>
							<a href="#" onclick="openOverlay('lindstromoverlay', event)">	
								<h3>Growth by making technology</h3>
								<h4 class="programSpeaker">Nina Lindström</h4>
							</a>
						</div>
						<div class="programItem venue3">
							<time>11:00 - 12:00</time>
							<a href="#" onclick="openOverlay('norrevikoverlay', event)">	
								<h3>Pitcha ditt företag till geek girls!</h3>
								<h4 class="programSpeaker">Lisa Norrevik</h4>
							</a>
						</div>
						<div class="programItem venue2">
						...
						<div class="programItem venue1">
							...
							<a href="#" onclick="openOverlay('hofvanderoverlay', event)">
								<h4 class="programSpeaker">Siren Hofvander</h4>
							</a>
						</div>
						<div class="programItem venue2">
							<time>11:30 - 11:45</time>
							<a href="http://bigsister.se/speaker/jenny-hellenberg-simin-liu/">
								<h3>Software development as science fiction</h3>
								<h4 class="programSpeaker">Nataliia Nuzhdina (Iteam)</h4>
							</a>
							<span class="pointLang">(eng)</span>
						</div>
						...
						<div class="programItem venue1">
							...
							<a href="#" onclick="openOverlay('demredoverlay', event)">
								<h3>Framtiden för live-video</h3>
								<h4 class="programSpeaker">Annelie Demred</h4>
							</a>
						</div>
						<div class="programItem venue2">
							<time>13:00 - 13:30</time>
							<a href="#" onclick="openOverlay('kareliussonoverlay', event)">
								<h3>Hack yourself – biohacking & mänsklig evolution</h3>
								<h4 class="programSpeaker">Maria Kareliusson</h4>
							</a>
						</div>
						<div class="programItem venue3">
							<time>13:15 - 13:30</time>
							<a href="#" onclick="openOverlay('hallstromoverlay', event)">
								<h3>Från utbränd till entreprenör</h3>
								<h4 class="programSpeaker">Emma Hällström</h4>
							</a>
						</div>
						<div class="programItem venue3">
							<time>13:35 - 13:50</time>
							<h3>TBA</h3>
						</div>
						<div class="programItem venue1">
							<time>13:45 - 14:15</time>
							<a href="#" onclick="openOverlay('hakanssonoverlay', event)">
								<h3>AI och framtiden</h3>
								<h4 class="programSpeaker">Anne Håkansson</h4>
							</a>
						</div>
						<div class="programItem venue2">
							<time>13:45 - 14:00</time>
							<h3>Framtidens arbetssätt i sjukvården</h3>
							<h4 class="programSpeaker">Sara Lei</h4>
						</div>
						<div class="programItem venue2">
							<time>14:05 - 14:20</time>
							<a href="#" onclick="openOverlay('idebrooverlay', event)">
								<h3>Om världen varit jämställd hade jag hållit det här talet på Mars</h3>
								<h4 class="programSpeaker">Maria Idebro</h4>
							</a>
						</div>
						<div class="programItem venue3">
							<time>14:10 - 14:25</time>
							<h3>Robotik inom vård och omsorg</h3>
							<h4 class="programSpeaker">Catharina Borgenstierna</h4>
						</div>
						<div class="programItem venue1">
							<time>14:30 - 15:00</time>
							<a href="#" onclick="openOverlay('polioverlay', event)">
								<h3>Så skapar vi en inkluderande framtid</h3>
								<h4 class="programSpeaker">Siduri Poli</h4>
							</a>
						</div>
						<div class="programItem venue2">
							<time>14:30 - 14:45</time>
							<a href="#" onclick="openOverlay('kindlundhoverlay', event)">
								<h3>Kina - världens hetaste VR-marknad</h3>
								<h4 class="programSpeaker">Eva Kindlundh</h4>
							</a>
						</div>
						<div class="programItem venue3">
							<time>14:30 - 14:45</time>
							<h4 class="programSpeaker">Caroline Cakka Wallmark & Lisa Sällvin</h4>
						</div>
						<div class="programItem venue2">
							<time>14:50 - 15:05</time>
							<a href="#" onclick="openOverlay('torneusoverlay', event)">
								<h3>Teknologi för hjärta och hjärna</h3>
								<h4 class="programSpeaker">Mimmi Torneus (Iteam)</h4>
							</a>
						</div>
						...
						<div class="programItem venue1">
							...
							<h3>Unpanel?</h3>
							<h4 class="programSpeaker">Anita Sarkeesian</h4>
						</div>
						<div class="programItem venue2">
						...
						<div class="programItem venue2">
							<time>15:50 - 16:05</time>
							<h4 class="programSpeaker">Tuva Palm</h4>
						</div>
						<div class="programItem venue1">
							<time>16:00 - 16:30</time>
							<a href="#stipendiet">
								<h3>Prisutdelning Elisabeth Tegner-stipendiet</h3>
								<h4 class="programSpeaker">Emelie Fågelstedt & Elisabeth Tegner</h4>
							</a>
						</div>
						<div class="programItem venue2">
							<time>16:10 - 16:25</time>
							<h3>TBA</h3>
						</div>
						<div class="programItem venue1">
						...
						<div class="programItem venue1">
							...
							<a href="#" onclick="openOverlay('sandberglindhoverlay', event)">
								<h3>Geek Evolution-Quiz!!!</h3>
								<h4 class="programSpeaker" >Copylinda & Kafkaspice</h4>
							</a>
						</div>
						
						<div class="programItem common">
							<time>18:00 - 22:00</time>
							<h3>Fest/mingel</h6>
						</div>
					</div>				
				</div>
			...
			<div class="programDesktop">
				<div class="programDay">
					<div class="programVenueTitles">
						<div>
							<h5>Verkstaden</h5>
						</div>
						<div>
